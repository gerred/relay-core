...
const (
	...
	TenantStatusReasonVolumeClaimMissing = "VolumeClaimMissing"
	TenantStatusReasonVolumeClaimError   = "VolumeClaimError"
...
func ConfigureTenant(t *Tenant, td *TenantDepsResult, jcs []batchv1.JobCondition) {
	...
	conds := map[relayv1beta1.TenantConditionType]*relayv1beta1.Condition{
		...
		relayv1beta1.TenantVolumeClaimReady: &relayv1beta1.Condition{},
	...
	UpdateStatusConditionIfTransitioned(conds[relayv1beta1.TenantVolumeClaimReady], func() relayv1beta1.Condition {
		if td.TenantDeps != nil {
			if ti := td.TenantDeps.ToolInjection; ti != nil {
				complete := false
				failed := false
				...
				if complete {
					if failed {
						return relayv1beta1.Condition{
							Status:  corev1.ConditionFalse,
							Reason:  TenantStatusReasonVolumeClaimError,
							Message: "Error processing volume claim.",
						}
					}
			...
			return relayv1beta1.Condition{
				Status:  corev1.ConditionTrue,
				Reason:  TenantStatusReasonVolumeClaimMissing,
				Message: "The tenant does not have a volume claim defined.",
			}
		}
	...
	UpdateStatusConditionIfTransitioned(conds[relayv1beta1.TenantReady], func() relayv1beta1.Condition {
		switch AggregateStatusConditions(*conds[relayv1beta1.TenantNamespaceReady], *conds[relayv1beta1.TenantEventSinkReady], *conds[relayv1beta1.TenantVolumeClaimReady]) {
		case corev1.ConditionTrue:
			return relayv1beta1.Condition{
				Status:  corev1.ConditionTrue,
	...
	t.Object.Status = relayv1beta1.TenantStatus{
		...
		Conditions: []relayv1beta1.TenantCondition{
			...
			{
				Condition: *conds[relayv1beta1.TenantVolumeClaimReady],
				Type:      relayv1beta1.TenantVolumeClaimReady,
			},
			{
